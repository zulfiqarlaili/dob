    ...
    await fetch(baseUrl + '/aboutMe/', {
      ...
      .then((json) => {
        ...
        const additionalText =
          ' Additionally, you may consult with a metaphysician to obtain an in-depth analysis of above diagram.';
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <Text id='modal-description'>{error}</Text>
        </Modal.Body>
      </Modal>
      ...
      {elements.length > 0 && (
        <>
          ...
          >
            <Text size='$2xl' css={{ fontWeight: '$bold' }}>
